...
func (p *Parser) parseIfExpression() ast.Expression {
	...
	if !p.expectPeek(token.LBRACE) {
		p.errors = append(p.errors, "expected opening brace")
		return nil
	}

	expression.Consequence = p.praseBlockStatement()
	...
	if p.peekTokenIs(token.ELSE) {
		...
		expression.Alternative = p.praseBlockStatement()
	}

	return expression
}

func (p *Parser) praseBlockStatement() *ast.BlockStatement {
...
func (p *Parser) parseFunctionLiteral() ast.Expression {
	...
	lit.Body = p.praseBlockStatement()
